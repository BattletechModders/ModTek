...
internal class AppenderFile : IDisposable
{
    ...
    internal AppenderFile(string path, AppenderSettings settings)
    {
        ...
        Write(
            ...
            Memcpy512oTicks {FastBuffer.Memcpy512oTicks} ; Memcpy512Ticks {FastBuffer.Memcpy512Ticks} ; Memcpy256Ticks {FastBuffer.Memcpy256Ticks} ; Memcpy128Ticks {FastBuffer.Memcpy128Ticks} ; Memcpy64Ticks {FastBuffer.Memcpy64Ticks}
            {new string('-', 80)}
